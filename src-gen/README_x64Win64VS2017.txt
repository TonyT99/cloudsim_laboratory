...
data type DatacenterSimple from datacentersimple.idl.
This example builds two applications, named DatacenterSimplePublisher
and DatacenterSimpleSubscriber.
...
open/double-click and edit the DatacenterSimplePublisher.java file
where it says:
...
-------------
Type 
> ant DatacenterSimplePublisher
or
> ant DatacenterSimpleSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the DatacenterSimplePublisher or DatacenterSimpleSubscriber
application.
