...
public class MyDDSReportSubsciber {
    ...
    private final ArrayList<MyDDSReportSubsciber> collectedData = new ArrayList<>();

    public MyDDSReportSubsciber(int sampleNumber) { this.sampleNumber = sampleNumber; }
    public ArrayList<MyDDSReportSubsciber> getCollectedData() { return collectedData; }
