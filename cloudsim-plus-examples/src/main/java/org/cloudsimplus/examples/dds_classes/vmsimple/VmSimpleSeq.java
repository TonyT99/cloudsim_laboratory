...
/**
* A sequence of VmSimple instances.
*/
public final class VmSimpleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public VmSimpleSeq() {
        super(DdsVmSimple.class);
    }

    public VmSimpleSeq (int initialMaximum) {
        super(DdsVmSimple.class, initialMaximum);
    }

    public VmSimpleSeq (Collection<?> elements) {
        super(DdsVmSimple.class, elements);
    }

    public DdsVmSimple get(int index) {
        return (DdsVmSimple) super.get(index);
    }
