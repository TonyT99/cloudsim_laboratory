...
data type ddsreport from ddsreport.idl.
This example builds two applications, named ddsreportPublisher
and ddsreportSubscriber.
...
open/double-click and edit the ddsreportPublisher.java file
where it says:
...
-------------
Type 
> ant ddsreportPublisher
or
> ant ddsreportSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the ddsreportPublisher or ddsreportSubscriber
application.
