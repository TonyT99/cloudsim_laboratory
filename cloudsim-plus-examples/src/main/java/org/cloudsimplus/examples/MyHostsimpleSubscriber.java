...
public class MyHostsimpleSubscriber {
    ...
    private final ArrayList<MyHostsimpleSubscriber> collectedData = new ArrayList<>();

    public MyHostsimpleSubscriber(int samplesNumber) { this.samplesNumber = samplesNumber; }

    public ArrayList<MyHostsimpleSubscriber> getCollectedData() { return collectedData; };
