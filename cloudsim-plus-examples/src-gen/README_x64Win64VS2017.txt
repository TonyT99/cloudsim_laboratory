...
data type HostSimple from hostsimple.idl.
This example builds two applications, named HostSimplePublisher
and HostSimpleSubscriber.
...
open/double-click and edit the HostSimplePublisher.java file
where it says:
...
-------------
Type 
> ant HostSimplePublisher
or
> ant HostSimpleSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the HostSimplePublisher or HostSimpleSubscriber
application.
