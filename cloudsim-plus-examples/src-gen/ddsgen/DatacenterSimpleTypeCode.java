...
public class  DatacenterSimpleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_LONG);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_LONG);
        sm[__i] = new  StructMember("timestampOfReport", false, (short)-1,  false, TypeCode.TC_LONG, 1, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("ddsgen.DatacenterSimple",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);
        return tc;
    }
}
