...
/**
* A sequence of ddsgen.VmSimple instances.
*/
public final class VmSimpleSeq extends LoanableSequence implements Copyable {
    ...
    */
    ...
    public VmSimpleSeq() {
        super(VmSimple.class);
    }

    public VmSimpleSeq (int initialMaximum) {
        super(VmSimple.class, initialMaximum);
    }

    public VmSimpleSeq (Collection<?> elements) {
        super(VmSimple.class, elements);
    }

    public  VmSimple get(int index) {
        return (VmSimple) super.get(index);
    }
        ...
        for(int i = 0; (i < origSize) && (i < srcSize); i++){
            if (typedSrc.get(i) == null){
                ...
                if (get(i) == null){
                    ...
                    set(i, VmSimple.create());
                }
                set(i, ((Copyable) get(i)).copy_from(typedSrc.get(i)));
            }
        }

        // copy 'new' ddsgen.VmSimple objects (beyond the original size of this object)
