...
public class  VmSimpleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_USHORT);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_USHORT);
        sm[__i] = new  StructMember("hostId", false, (short)-1,  false, TypeCode.TC_USHORT, 1, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        ...
        sm[__i] = new  StructMember("mips", false, (short)-1,  false, TypeCode.TC_ULONG, 3, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        memberAnnotation.default_annotation(AnnotationParameterValue.ZERO_ULONG);
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_ULONG);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_ULONG);
        sm[__i] = new  StructMember("numberOfPEs", false, (short)-1,  false, TypeCode.TC_ULONG, 4, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        memberAnnotation.default_annotation(AnnotationParameterValue.ZERO_ULONG);
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_ULONG);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_ULONG);
        sm[__i] = new  StructMember("ram", false, (short)-1,  false, TypeCode.TC_ULONG, 5, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        memberAnnotation.default_annotation(AnnotationParameterValue.ZERO_ULONG);
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_ULONG);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_ULONG);
        sm[__i] = new  StructMember("bw", false, (short)-1,  false, TypeCode.TC_ULONG, 6, false, memberAnnotation);__i++;
        memberAnnotation = new Annotations();
        memberAnnotation.default_annotation(AnnotationParameterValue.ZERO_ULONG);
        memberAnnotation.min_annotation(AnnotationParameterValue.MIN_ULONG);
        memberAnnotation.max_annotation(AnnotationParameterValue.MAX_ULONG);
        sm[__i] = new  StructMember("size", false, (short)-1,  false, TypeCode.TC_ULONG, 7, false, memberAnnotation);__i++;

        Annotations annotation = new Annotations();
        annotation.allowed_data_representation_mask(5);

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("ddsgen.VmSimple",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm , annotation);
        return tc;
    }
}
