...
/**
* A sequence of Cloudlet instances.
*/
public final class CloudletSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CloudletSeq (int initialMaximum) {
        super(Cloudlet.class, initialMaximum);
    }

    public CloudletSeq (Collection<?> elements) {
    ...
    */
    ...
    public java.lang.Object copy_from(java.lang.Object src) {
        ...
        // copy 'new' Cloudlet objects (beyond the original size of this object)
