...
public class CloudletTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "Cloudlet";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CloudletTypeSupport _singleton
    = new CloudletTypeSupport();
    ...
    */
    public static CloudletTypeSupport get_instance() {
        return _singleton;
    }

    public static CloudletTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CloudletTypeCode.VALUE;
    }

    @Override
    public java.lang.Object create_data() {
        return Cloudlet.create();
    }
    ...
    * <code>this</code> is not a <code>Cloudlet</code>
    * type.
    */
    @Override 
    public java.lang.Object copy_data(java.lang.Object destination, java.lang.Object source) {

        Cloudlet typedDst = (Cloudlet) destination;
        Cloudlet typedSrc = (Cloudlet) source;
        ...
        java.lang.Object sample)
    {
        ...
        short encapsulation_id = CdrEncapsulation.getEncapsulationFromFinal(
            ...
            ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY);
        boolean xcdr1 = (encapsulation_id <= CdrEncapsulation.CDR_ENCAPSULATION_ID_PL_CDR_LE);
        Cloudlet typedSrc = (Cloudlet) sample;
        ...
        currentAlignment  +=  _cdrPrimitiveType.getStringSerializedSize(epd.getAlignment(currentAlignment), typedSrc.modelType );
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if(deserialize_sample) {
            ...
            Cloudlet typedDst = (Cloudlet) dst;
            typedDst.clear();      
            int DHtmpPosition = 0;
            int DHtmpSize = 0;
            long DHtmpLength = 0;
        ...
        java.lang.Object endpoint_plugin_qos)
    {
        ...
        if (deserialize_key) {
            ...
            Cloudlet typedDst = (Cloudlet) sample;
            deserialize_sample(
    ...
    int mask) {
        return new CloudletDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new CloudletDataReader(native_reader, listener, mask, this);   
    ...
    protected CloudletTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false, CloudletTypeCode.VALUE, Cloudlet.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CloudletTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport, CloudletTypeCode.VALUE, Cloudlet.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
