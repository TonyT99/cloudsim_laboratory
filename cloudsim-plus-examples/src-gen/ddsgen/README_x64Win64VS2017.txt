...
data type ddsgen.DatacenterSimple from datacentersimple.idl.
This example builds two applications, named ddsgen.DatacenterSimplePublisher
and ddsgen.DatacenterSimpleSubscriber.
...
open/double-click and edit the ddsgen.DatacenterSimplePublisher.java file
where it says:
...
-------------
Type 
> ant ddsgen.DatacenterSimplePublisher
or
> ant ddsgen.DatacenterSimpleSubscriber
 
Run with Eclipse:
-----------------
Select Run > Run and choose either the ddsgen.DatacenterSimplePublisher or ddsgen.DatacenterSimpleSubscriber
application.
