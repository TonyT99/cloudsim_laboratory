...
/**
* A reader for the ddsgen.VmSimple user type.
*/
public class VmSimpleDataReader extends DataReaderImpl {
    ...
    public void read_next_sample(VmSimple received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(VmSimple received_data, SampleInfo sample_info) {
    ...
    public void get_key_value(VmSimple key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(VmSimple key_holder) {
