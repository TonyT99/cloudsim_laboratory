...
public class VmSimpleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final java.lang.String TYPE_NAME = "ddsgen.VmSimple";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};
    private static final VmSimpleTypeSupport _singleton
    = new VmSimpleTypeSupport();
    ...
    */
    public static VmSimpleTypeSupport get_instance() {
        return _singleton;
    }

    public static VmSimpleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return VmSimpleTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>ddsgen.VmSimple</code>
    * type.
    */
    @Override
        ...
        java.lang.Object sample)
    {
        ...
        currentAlignment  +=  _cdrPrimitiveType.getShortMaxSizeSerialized(epd.getAlignment(currentAlignment));
    ...
    boolean serialize_sample, java.lang.Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeInt(typedSrc.numberOfPEs);
    ...
    */
    ...
    int mask) {
        return new VmSimpleDataWriter (native_writer, listener, mask, this);
    }
    ...
    int mask) {
        ...
        return new VmSimpleDataReader(native_reader, listener, mask, this);
